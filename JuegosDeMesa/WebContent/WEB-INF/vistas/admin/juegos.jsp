			...
			<h4>Busqueda</h4>
				...
				<div class="mb-3">
					<label for="autor" class="form-label">Autor</label> <input
						type="text" class="form-control" name="autor" id="autor" placeholder="Inserte un autor..">
				</div>
				<div class="mb-3">
					<label for="editorial" class="form-label">Editorial</label> <input
						type="text" class="form-control" name="editorial" placeholder="Inserte una editorial..." id="editorial">
				</div>
				<div class="mb-3">
					<label for="mecanica" class="form-label">Mecanica</label>
					 <input type="text" class="form-control" name="mecanica" placeholder ="Inserte una mecanica..." id="mecanica">
				</div>
